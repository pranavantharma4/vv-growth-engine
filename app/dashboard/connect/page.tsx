...
export default function ConnectPage() {
  ...
  if (loading) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '60vh' }}>
      <div style={{ fontFamily: MONO, fontSize: 9, color: 'var(--ink3)', letterSpacing: '2px', textTransform: 'uppercase' }}>Loading connections...</div>
    </div>
  )
  ...
  return (
    <div style={{ maxWidth: 640, margin: '0 auto' }}>
      <div style={{ marginBottom: 28 }}>
        <div style={{ fontFamily: MONO, fontSize: 8, color: 'var(--ink3)', letterSpacing: '2.5px', textTransform: 'uppercase', marginBottom: 6 }}>Connections</div>
        <div style={{ fontFamily: SERIF, fontSize: 28, fontWeight: 300, color: 'var(--ink)', marginBottom: 4 }}>Ad Account Connections</div>
        <div style={{ fontFamily: MONO, fontSize: 9, color: 'var(--ink3)', letterSpacing: '1px' }}>
          Connect your ad platform — or enter campaigns manually. Both work side by side.
        </div>
      </div>
      ...
      <div style={{ background: 'var(--bg2)', border: `1px solid ${connection && !isExpired ? 'rgba(74,222,128,0.2)' : isExpired ? 'rgba(248,113,113,0.2)' : 'var(--rule)'}`, borderRadius: 8, padding: '24px', marginBottom: 12 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: MONO, fontSize: 8, color: 'var(--ink3)', letterSpacing: '1px', marginTop: 2 }}>Facebook & Instagram Advertising</div>
            </div>
          </div>
          <div>
            {connection && !isExpired ? (
              <span style={{ fontFamily: MONO, fontSize: 8, color: '#4ade80', background: 'rgba(74,222,128,0.08)', border: '1px solid rgba(74,222,128,0.2)', padding: '3px 10px', borderRadius: 2, letterSpacing: '1.5px' }}>
                ● CONNECTED
              </span>
            ) : isExpired ? (
              <span style={{ fontFamily: MONO, fontSize: 8, color: '#f87171', background: 'rgba(248,113,113,0.08)', border: '1px solid rgba(248,113,113,0.2)', padding: '3px 10px', borderRadius: 2, letterSpacing: '1.5px' }}>
                ● EXPIRED
              </span>
            ) : (
              <span style={{ fontFamily: MONO, fontSize: 8, color: 'var(--ink3)', background: 'var(--rule)', border: '1px solid var(--rule2)', padding: '3px 10px', borderRadius: 2, letterSpacing: '1.5px' }}>
                NOT CONNECTED
              </span>
            )}
          </div>
        ...
        {isExpired && (
          <div style={{ background: 'rgba(248,113,113,0.06)', border: '1px solid rgba(248,113,113,0.15)', borderRadius: 4, padding: '12px 14px', marginBottom: 16 }}>
            <div style={{ fontFamily: MONO, fontSize: 8, color: '#f87171', letterSpacing: '1px', lineHeight: 1.7 }}>
      ...
      {/* Manual entry — equal alternative */}
      <div style={{ background: 'var(--bg2)', border: '1px solid var(--rule)', borderRadius: 8, padding: '24px', marginBottom: 12 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ width: 36, height: 36, background: 'var(--goldpaper)', border: '1px solid var(--goldborder)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ color: 'var(--gold)', fontWeight: 700, fontSize: 14, fontFamily: MONO }}>✎</span>
            </div>
            <div>
              <div style={{ fontFamily: SANS, fontSize: 14, color: 'var(--ink)', fontWeight: 500 }}>Manual Campaign Entry</div>
              <div style={{ fontFamily: MONO, fontSize: 8, color: 'var(--ink3)', letterSpacing: '1px', marginTop: 2 }}>Any platform — enter spend, revenue, conversions</div>
            </div>
          </div>
          <button
            onClick={() => router.push('/dashboard/add-campaign')}
            style={{ fontFamily: MONO, fontSize: 9, fontWeight: 600, letterSpacing: '1.5px', color: '#050509', background: 'var(--gold)', border: 'none', padding: '11px 22px', borderRadius: 4, cursor: 'pointer' }}>
            Add Campaign →
          </button>
        </div>
      </div>
      ...
      <div style={{ background: 'var(--bg2)', border: '1px solid var(--rule)', borderRadius: 8, padding: '24px', marginBottom: 12, opacity: 0.6 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <div style={{ fontFamily: SANS, fontSize: 14, color: 'var(--ink)', fontWeight: 500 }}>Google Ads</div>
              <div style={{ fontFamily: MONO, fontSize: 8, color: 'var(--ink3)', letterSpacing: '1px', marginTop: 2 }}>Search, Display & YouTube</div>
            </div>
          </div>
          <span style={{ fontFamily: MONO, fontSize: 8, color: 'var(--ink3)', background: 'var(--rule)', border: '1px solid var(--rule2)', padding: '3px 10px', borderRadius: 2, letterSpacing: '1.5px' }}>
            COMING SOON
      ...
      <div style={{ background: 'var(--bg2)', border: '1px solid var(--rule)', borderRadius: 8, padding: '24px', opacity: 0.6 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <div style={{ fontFamily: SANS, fontSize: 14, color: 'var(--ink)', fontWeight: 500 }}>TikTok Ads</div>
              <div style={{ fontFamily: MONO, fontSize: 8, color: 'var(--ink3)', letterSpacing: '1px', marginTop: 2 }}>TikTok for Business</div>
            </div>
          </div>
          <span style={{ fontFamily: MONO, fontSize: 8, color: 'var(--ink3)', background: 'var(--rule)', border: '1px solid var(--rule2)', padding: '3px 10px', borderRadius: 2, letterSpacing: '1.5px' }}>
            COMING SOON
